...
/**
 * Team Project PlantMancalaBoard.java file
 *
 ...
 */
public class PlantsMancalaBoard implements MancalaBoardShape 
{
	/**
	...
	/**
	 * Return the image of the background for the application, which in this case is the picture of the plants
	 *
	 * @return the image of the background
	 */
	public Image mancalaBoardBGImage() 
	{
		return Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Plants.jpeg"));
	}
}