...
/**
 * Team Project WoodMancalaBoard.java file
 *
 ...
 */
public class WoodMancalaBoard implements MancalaBoardShape 
{
	/**
	...
	/**
	 * Return the image of the background for the application, which in this case is the picture of the wood planks
	 *
	 * @return the image of the background
	 */
	public Image mancalaBoardBGImage() 
	{
		return Toolkit.getDefaultToolkit().getImage(getClass().getResource("/Wood.jpeg"));
	}
}